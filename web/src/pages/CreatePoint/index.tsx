...
/* sempre que for criado um estado (useState) para um array e um objeto,
é necessário sempre informar o tipo de variável que será armazenada,
para indicar o tipo de dado usamos o interface*/
...
const CreatePoint = () => {
    ...
    //informa que o estado é um array (Item) com a interface definida acima
    ...
    useEffect(() => {
        axios.get<ibgeUFs[]>('https://servicodados.ibge.gov.br/api/v1/localidades/estados').then(response => {
            const ufInitials = response.data.map(ibgeUF => ibgeUF.sigla);
